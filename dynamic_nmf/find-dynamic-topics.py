...
def main():
    ...
    for window_model_path in args:
        ...
        (doc_ids, terms, term_rankings, partition, W, H, window_topic_labels) = unsupervised.nmf.load_nmf_results(
            window_model_path)
    ...
    for k in range(kmin, kmax + 1):
        ...
        unsupervised.nmf.save_nmf_results(results_out_path, collection.topic_ids, all_terms, term_rankings, partition,
